...
class AutoReply_v2(commands.Cog):
    def __init__(self, bot):
        self.bot = bot
        self.MODEL_PATH = os.path.abspath('./models/AutoReply/AutoReply_model.bin')
        self.VOCAB_PATH = os.path.abspath('./models/AutoReply/tokenizer.json')
        self.CONFIG_PATH = os.path.abspath('./models/AutoReply/config.json')
        self.LABEL_PATH = os.path.abspath('./models/AutoReply/labels.txt')
...
async def setup(bot):
    await bot.add_cog(AutoReply_v2(bot))
    print("AutoReply_v2.py is ready")