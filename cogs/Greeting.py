...
class Greeting(commands.Cog):
    def __init__(self, bot):
        self.bot = bot
        self.MODEL_PATH = os.path.abspath('./models/Greeting/greeting_model.bin')
        self.VOCAB_PATH = os.path.abspath('./models/Greeting/tokenizer.json')
        self.CONFIG_PATH = os.path.abspath('./models/Greeting/config.json')
