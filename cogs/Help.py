...
class Help(commands.Cog):
  ...
  async def Help(self,ctx):
    ...
    help_embed.add_field(name="!DM",value="邀請小妖精私訊",inline=False)
    ...
    help_embed.add_field(name="!Math [計算公式]",value="小妖精幫您計算數學",inline=False)
    help_embed.add_field(name="!Join",value="小妖精進入語音聊天室",inline=False)
    help_embed.add_field(name="!Leave",value="小妖精離開語音聊天室",inline=False)
    help_embed.add_field(name="!Play [網址]",value="小妖精播放音樂(目前支援以下平台:StreetVoice)",inline=False)
    help_embed.add_field(name="!Ping",value="小妖精在Discord WebSocket協議的延遲",inline=False)
